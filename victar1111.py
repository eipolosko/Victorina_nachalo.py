...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.radioButton.setGeometry(QtCore.QRect(0, 60, 120, 17))
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.tab)
        self.radioButton_2.setGeometry(QtCore.QRect(0, 90, 120, 17))
        ...
        self.labelRes1.setGeometry(QtCore.QRect(160, 140, 201, 21))
        self.labelRes1.setObjectName("labelRes1")
        self.label_rez2 = QtWidgets.QLabel(self.tab)
        self.label_rez2.setGeometry(QtCore.QRect(130, 350, 201, 21))
        self.label_rez2.setObjectName("label_rez2")
    ...
    def qwes2(self):
        _translate = QtCore.QCoreApplication.translate
        self.label_1.setText(_translate("MainWindow", "Кто такой ара"))
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
    ...
    def add_function(self):
        ...
        self.radioButton_3.clicked.connect(self.qwes2)
